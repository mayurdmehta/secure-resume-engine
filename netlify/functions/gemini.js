...
**2. EXECUTE:**
   ...
   - Rewrite the selected accomplishment summaries following these strict rules:
     ...
     - **Structure:** Rewrite the accomplishment into a flowing, natural sentence. Start with the result/metric, then describe the action taken, and end with the business outcome. Do NOT use "->" or other arrows in the final text.
