...
import { initBlogs } from './blogs.js'; // NEW
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
    ...
    <div id="blogs" class="page hidden">
        <header class="text-center py-12">
            ...
            <p class="text-lg text-gray-400">Thoughts on AI, product, and systems.</p>
        </header>
        <div class="container mx-auto px-4 max-w-5xl">
            <div id="blogs-error" class="hidden p-4 mb-6 rounded-lg bg-red-500/10 border border-red-500/30 text-red-300"></div>
            <section id="blogs-list" class="grid grid-cols-1 md:grid-cols-2 gap-6"></section>
            <article id="blogs-detail" class="prose prose-dark max-w-none hidden"></article>
        </div>
    </div>
